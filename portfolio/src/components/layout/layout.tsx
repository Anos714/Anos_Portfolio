const Layout = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="mx-auto min-h-screen max-w-[1000px] px-4">
      <div className="grid min-h-screen grid-cols-1 bg-white sm:grid-cols-[40px_1fr_40px] sm:gap-5 dark:bg-neutral-900">
        {/* LEFT RAIL */}
