...
const requiredEnv = ["DATABASE_URL", "UPSTASH_REDIS_REST_URL", "UPSTASH_REDIS_REST_TOKEN", "VISITOR_HASH_SALT"];
...
const parseOrigins = (value) => (cleanEnvValue(value) ?? "http://127.0.0.1:5173,http://localhost:5173")
    .split(",")
